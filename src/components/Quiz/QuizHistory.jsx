  ...
  if (viewMode === 'results' && selectedQuiz) {
    return (
      <div className="card">
        ...
        {/* Participant Results */}
        <div>
          <h4 className="font-semibold text-bible-blue mb-4">Participant Results</h4>
          {selectedQuiz.results.length === 0 ? (
            ...
            <div className="space-y-3 max-h-96 overflow-y-auto">
              {selectedQuiz.results.map((result, index) => (
                <div key={result.id || index} className="border rounded-lg p-4 bg-white">
                  <div className="flex justify-between items-center">
                    <div className="flex-1">
                      <h5 className="font-semibold text-bible-blue">{result.userName}</h5>
